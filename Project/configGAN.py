...
def flying_objects_config():
  ...
  cfg.GPU = 0                 # GPU ID
  cfg.DROPOUT_PROB = 0      # Probability to discard a node in dropout
  ...
  cfg.LEARNING_RATE = 0.9  # learning rate
  cfg.LR_DECAY_FACTOR = 0.8   # multiply the learning rate by this factor
